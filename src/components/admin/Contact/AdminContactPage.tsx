...
const DEFAULT_QUERIES: ContactQuery[] = [
  {
    ...
    message:
      "Hello, I am looking to install a 10kW solar system on my rooftop in Austin. Could you please send me an estimated pricing sheet and available tax rebate info?",
  ...
  },
  {
    ...
    message:
      "We operate a commercial facility and wish to integrate high-capacity Tesla Powerwall or commercial battery backups to mitigate power outages.",
  ...
  },
  {
    ...
    message:
      "Our inverter displays an error code E-04 since yesterday morning. We need an urgent technician dispatch.",
  ...
  },
  {
    ...
    message:
      "Hi! I wanted to check what brand of solar panels you supply and if they come with a 25-year performance warranty.",
