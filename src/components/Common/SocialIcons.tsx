...
export function buildSettings(sections: Section[]): ChatSettings {
...
export const DEFAULT_CHAT_SETTINGS = buildSettings(DEFAULT_SECTIONS);
...
export function getSocialLinks(settings: ChatSettings): SocialLinkItem[] {
  ...
  if (settings.showMessenger && settings.messengerUsername) {
    links.push({
      key: "messenger",
      href: `https://m.me/${settings.messengerUsername}`,
  ...
  if (settings.showFacebook && settings.facebookUrl.trim()) {
    links.push({
      key: "facebook",
  ...
  if (settings.showLinkedin && settings.linkedinUrl.trim()) {
    links.push({
      key: "linkedin",
  ...
  if (settings.showYoutube && settings.youtubeUrl.trim()) {
    links.push({
      key: "youtube",
