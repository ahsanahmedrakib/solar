...
import { useQuerySettings, useQueryServices } from "@/lib/queries";
...
export default function Footer() {
  ...
  const { data: rawServices = [], isFetching: servicesFetching, isLoading: servicesIsLoading } = useQueryServices();
  ...
  const settings = useMemo(() => {
    ...
    return {
      ...
      tagline:
        getField(data, "general", "brand-tagline") || FALLBACK.tagline,
              ...
              <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center gap-3">
                  {showSkeleton
                    ...
                    : (
                        [
                          { key: "socialFb", label: "facebook" as const, href: settings.socialFb },
                          { key: "socialX", label: "x" as const, href: settings.socialX },
                          { key: "socialIg", label: "instagram" as const, href: settings.socialIg },
                          { key: "socialLi", label: "linkedin" as const, href: settings.socialLi },
                        ] as const
                      )?.map(
                        (platform) =>
                          platform.href && (
          ...
          <div className="pt-8 text-center">
            {showSkeleton ? (
              ...
              <p className="text-xs sm:text-sm text-gray-500 font-medium tracking-wide">
                Copyright © {new Date().getFullYear()} {settings.companyName}.
                All rights reserved.
              </p>
            )}
          </div>
