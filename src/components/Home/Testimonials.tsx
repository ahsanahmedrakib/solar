    ...
    <section className="bg-white py-20 lg:py-25 px-4 sm:px-6 lg:px-8 font-sans overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Reveal variant="fade-up">
              <span className="section-eyebrow">Our Testimonials</span>
            </Reveal>
            ...
            <Reveal variant="fade-up" delay={180}>
              <div className="pt-2">
                <button
                  ...
                  className="btn-brand cursor-pointer group"
                >
                  Write A Review
            ...
            <Reveal variant="fade-up" delay={240}>
              <div className="bg-white rounded-lg p-5 border border-accent-500 shadow-sm max-w-sm mt-8 space-y-3">
                {loading ? (
                  ...
                  <>
                    <div className="flex items-center gap-3">
                      <span className="font-heading text-2xl font-extrabold text-accent-500">
                        {averageRating + "/" + 5}
                      </span>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => {
                    ...
                    <div className="flex items-center gap-4 pt-1">
                      <p className="text-xs font-bold text-[#888888] leading-tight">
            ...
            {loading ? (
              <div className="flex gap-6 overflow-hidden">
                {[1, 2, 3].map((n) => (
                  <div
                    key={n}
                    className="shrink-0 w-72.5 sm:w-85 bg-white rounded-lg p-6 mt-2 border border-accent-500 shadow-sm animate-pulse"
                  >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal */}
          <div className="relative bg-white rounded-lg shadow-2xl w-full max-w-lg p-6 sm:p-8 max-h-[90vh] overflow-y-auto">
            {/* Close Button */}
            <button
              onClick={() => {
                setShowModal(false);
            ...
            <h3 className="font-heading text-xl sm:text-2xl font-bold text-accent-500 mb-1">
              Write A Review
            </h3>
            ...
            >
              ...
              <div className="mt-2">
                <button
                  ...
                  className="w-full bg-accent-500 hover:bg-accent-600 disabled:bg-gray-400 text-secondary text-sm font-semibold px-6 py-3 rounded-2xl shadow-md transition-colors duration-200 cursor-pointer disabled:cursor-not-allowed"
                >
