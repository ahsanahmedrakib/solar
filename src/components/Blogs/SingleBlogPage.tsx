            ...
            <Reveal variant="fade-up" delay={100}>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-y border-gray-100 py-6 my-4">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-accent-500 text-xs font-bold mr-1">
                    Tags:
                  </span>
                  {blog.tags?.map((tag, idx) => (
                    <span
                      key={idx}
                      className="bg-accent-500 hover:bg-accent-400 text-accent-500 text-xs font-medium px-3 py-1 rounded-full transition-colors cursor-pointer"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    className="w-8 h-8 rounded-full bg-accent-500 hover:bg-accent-400 text-accent-500 flex items-center justify-center transition-colors"
