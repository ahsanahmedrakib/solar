...
export const heroSlides = pgTable("hero_slides", {
  ...
  description: text("description").notNull(),
  image: text("image").notNull(),
  backgroundVideo: text("background_video").notNull().default(""),
  useVideoBackground: boolean("use_video_background").notNull().default(false),
  site: varchar("site", { length: 20 }).notNull().default("ahead"),
