...
export const DEFAULT_PROJECTS: Project[] = [
  {
    ...
    location: "Austin, TX",
    description:
      "This project focused on designing and installing a high-efficiency rooftop solar system for a residential home to reduce electricity costs and promote the use of clean, renewable energy.",
    projectDetails:
  ...
  },
  {
    ...
    location: "Detroit, MI",
    description:
      "A large-scale industrial solar installation designed to power a manufacturing facility, significantly reducing operational energy costs and carbon emissions.",
    projectDetails:
  ...
  },
  {
    ...
    description:
      "A community-focused solar initiative that brings affordable clean energy to multiple households.",
    projectDetails:
  ...
  },
  {
    ...
    location: "Phoenix, AZ",
    description:
      "A commercial solar plant installed on a large office building, designed to offset a significant portion of the facility's energy consumption.",
    projectDetails:
  ...
  },
  {
    ...
    location: "Denver, CO",
    description:
      "A solar installation for an educational institute, providing hands-on learning opportunities for students while reducing operational costs.",
    projectDetails:
  ...
  },
  {
    ...
    location: "Miami, FL",
    description:
      "A hybrid solar system installed at a hospital facility, ensuring uninterrupted power supply for critical medical operations.",
    projectDetails:
