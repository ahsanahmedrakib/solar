    ...
    comments: [
      {
        ...
        website: "",
        comment: "This guide was incredibly helpful! I've been considering solar for my home and this answered so many of my questions. The breakdown of how panels work really made it easy to understand.",
        date: "Mar 1, 2026",
      },
      {
        id: 2,
        ...
        website: "https://markrivera.com",
        comment: "Great article. I would add that homeowners should also check their local utility company's net metering policies before making a decision. It can significantly affect the payback period.",
        date: "Mar 2, 2026",
      },
      {
        id: 3,
        ...
        website: "",
        comment: "Great point, Mark! Net metering policies vary widely by state and utility. We actually have a follow-up article coming soon that dives deeper into that topic.",
        date: "Mar 3, 2026",
      },
    ],
  },
    ...
    comments: [
      {
        ...
        website: "",
        comment: "The tax incentives alone make this worthwhile. We switched last year and the 30% federal tax credit made a huge difference in our overall cost.",
        date: "Mar 5, 2026",
      },
      {
        id: 2,
        ...
        email: "admin@solar.com",
        website: "",
        comment: "That's wonderful to hear, Emily! The tax credits are definitely a game-changer. How has your monthly savings been compared to before solar?",
        date: "Mar 6, 2026",
      },
      {
        id: 3,
        ...
        comment: "I appreciate the focus on energy independence. With rising electricity costs, having solar + battery storage gives me peace of mind that I won't be affected by rate hikes.",
        date: "Mar 8, 2026",
      },
    ],
  },
    ...
    comments: [
      {
        ...
        website: "",
        comment: "Finally an explanation that doesn't require an engineering degree to understand! The DC to AC conversion explanation was particularly clear.",
        date: "Mar 10, 2026",
      },
      {
        id: 2,
        ...
        email: "admin@solar.com",
        website: "",
        comment: "Thank you, Linda! We strive to make solar education accessible to everyone. Stay tuned for more simplified guides coming soon.",
        date: "Mar 11, 2026",
      },
    ],
  },
