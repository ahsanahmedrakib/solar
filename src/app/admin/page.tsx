        ...
        {stats.map((stat) => {
          ...
          return (
            <div key={stat.label} className="admin-stat-card">
              ...
              <div className="admin-stat-trend-row" style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div className="admin-section-card">
          <div className="admin-section-header">
            <div>
              ...
              <p className="admin-section-subtitle">Monthly sales performance</p>
            </div>
      ...
      <div className="admin-dashboard-grid">
        ...
        <div className="admin-table-card">
          <div className="admin-table-header">
            ...
            <a
              href="/admin/orders"
              style={{ fontSize: 12, color: "var(--admin-accent)", textDecoration: "none", fontWeight: 600 }}
            >
              View all →
            </a>
          </div>
